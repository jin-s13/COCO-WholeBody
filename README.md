...
2. The annotations of COCO-WholeBody dataset belong to SenseTime Research, and are licensed under a [Creative Commons Attribution 4.0 License](https://creativecommons.org/licenses/by-nc/4.0/legalcode).
